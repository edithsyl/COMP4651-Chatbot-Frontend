...
def check_credentials(email, password):
    ...
    # login_r = requests.post(apis.get("LOGIN"), login_body=test)
    # login_r_obj = login_r.json() 
   
    login_r_obj = {"token": "thisisadummytoken123"}
    # the above line is hardcoded, connect to backend, currently commented out...
...
# ------ MAIN PAGE ----- #
    ...
    if 'session_history' not in st.session_state:
        ...
        # ------ hard code alternative below
        st.session_state['session_history'] = {"sessionIds": [
                                                "6641e7a9a9af8ede1899ea75",
                                                "6641e7a9a9af8ede1899ea76",
                                                "6641ed29a77b0206c5675339"]}
        # ------ hard code ended
